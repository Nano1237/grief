...
/**
 * 
 * The Parent of the Default Controller.
 * It shoud just be used as error correction
 * @author Tim Rücker <tim.ruecker@ymail.com>
 * @copyright (c) 2015
 * 
 */
abstract class AbstractGriefDefaultController extends GriefControllerParent {
